      ...
      <div className="py-10 md:py-16">
        ...
        <div className="utxo-global-container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mt-10 md:mt-16">
            <div className="p-4 md:p-6 bg-[#F5F5F5] rounded-2xl font-medium h-full flex flex-col justify-between">
              <div>
            ...
            <div className="lg:pr-[400px] xl:pr-[350px]">
              <Collapse
                ...
                items={[
                  {
                    key: "1",
                    label: <div className="md:py-2 font-medium text-lg md:text-xl">{t("indexer.question.question_01")}</div>,
                    children: (
                      ...
                      --data '{ "id": 42, "jsonrpc": "2.0", "method": "get_indexer_tip", "params": [] }'`}
                        ...
                        <p>
                          ...
                          <Link href={TELEGRAM_LINK} className="text-orange-100 underline hover:underline hover:text-orange-100/60">
                            Telegram group
                          </Link>{" "}
                  ...
                  {
                    key: "2",
                    label: <div className="md:py-2 font-medium text-lg md:text-xl">{t("indexer.question.question_02")}</div>,
                    children: (
                      <div className="p-4 !pt-0 !pl-12 md:p-6 font-medium text-lg md:text-xl">
                  ...
                  {
                    key: "3",
                    label: <div className="md:py-2 font-medium text-lg md:text-xl">{t("indexer.question.question_03")}</div>,
                    children: (
                      <div className="p-4 !pt-0 !pl-12 md:p-6 font-medium text-lg md:text-xl">
                  ...
                  {
                    key: "4",
                    label: <div className="md:py-2 font-medium text-lg md:text-xl">{t("indexer.question.question_04")}</div>,
                    children: (
                      <div className="p-4 !pt-0 !pl-12 md:p-6 font-medium text-lg md:text-xl">
                        {t("indexer.answer.answer_04_content_01")}{" "}
                        <Link href={REQUEST_API_ACCESS_LINK} className="text-orange-100 underline hover:underline hover:text-orange-100/60">
                          Google Form
                        </Link>{" "}
                  ...
                  {
                    key: "5",
                    label: <div className="md:py-2 font-medium text-lg md:text-xl">{t("indexer.question.question_05")}</div>,
                    children: (
                      <div className="p-4 !pt-0 !pl-12 md:p-6 font-medium text-lg md:text-xl">
