      ...
      <div className="utxo-global-container">
        ...
        >
          <div>
            ...
            <p className="text-base text-grey-200 mt-2 mb-6 md:mb-10 max-w-[300px]">
              {t("feature.indexer.description")}
            </p>
          ...
          <img
            src="/images/indexer.png"
            alt="indexer"
            className="w-full md:w-[55%] mt-6 md:mt-0"
          />
        </div>

        <div className="hidden mt-4 md:mt-[60px] gap-10 md:flex pl-6 lg:pl-[144px] rounded-[24px] pr-5 md:pr-[42px] flex-col md:flex-row bg-center bg-cover bg-no-repeat bg-twa overflow-hidden">
          <img
            src="/images/twa.png"
            alt="twa"
            className="w-full md:w-[300px] lg:w-[426px]"
            data-aos="slide-up"
          />
          <div className="flex flex-col justify-center">
            <h6 className="text-[24px] leading-[32px] md:text-[32px] md:leading-[40px] lg:text-[40px] lg:leading-[48px] font-medium">
              {t("feature.telegram.title")}
            </h6>
            <p className="text-base text-grey-200 mt-2 mb-6 md:mb-10">
              {t("feature.telegram.description")}
            </p>
            <Link href={TWA_LINK} target="_blank" className="">
              <Button className="w-[157px]">
                <div className="flex items-center gap-2">
                  <span>{t("feature.telegram.btnLabel")}</span>
                </div>
              </Button>
            </Link>
          </div>
        ...
        <div className="block md:hidden mt-4 overflow-hidden">
          <div className="bg-center bg-no-repeat bg-cover bg-twa rounded-[24px] overflow-hidden flex justify-center">
            <img
              src="/images/twa.png"
              alt="twa"
              className="w-[200px]"
          ...
          <div className="flex flex-col justify-center mt-[28px] px-[14px]">
            <h6 className="text-[24px] leading-[32px] md:text-[32px] md:leading-[40px] lg:text-[40px] lg:leading-[48px] font-medium">
              {t("feature.telegram.title")}
            </h6>
            <p className="text-base text-grey-200 mt-2 mb-6 md:mb-10">
