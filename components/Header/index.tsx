    ...
    <>
      {showBanner && BOUNTY_CONTEST_STAGE !== BountyContestStage.Ended && (
        <div className="relative">
          <img
            src="/images/bounty-contest-banner.svg"
            alt="Bounty Contest"
            ...
            {BOUNTY_CONTEST_STAGE === BountyContestStage.Prepare ? (
              ...
              >
                <span className="hidden lg:block">
                  {t("bountyContest.joinNow")}
                </span>
                <span className="block lg:hidden">
                  {t("bountyContest.join")}
                </span>
                <svg
          ...
          <div className="hidden xl:flex items-center gap-4 lg:gap-10">
            {NAVIGATIONS.map((z, i) => (
              <Link
                ...
                target={z.isExternal ? "_blank" : "_self"}
                className={cn(
                  `text-grey-400 text-base transition-all hover:text-dark-100 flex gap-1 items-center font-medium`,
                  {
                    "text-dark-100":
                      localHash === z.href ||
                      (z.href === "/#about-us"
                      ...
                      (z.href === "/bounty-contest" &&
                        pathname === "/bounty-contest/"),
                    "text-orange-100 hover:text-orange-100/50": [
                      "/point-system",
                      "/persona",
                    ].includes(z.href),
                  }
              ...
              >
                {["/point-system", "/persona"].includes(z.href) && (
                  <IcnFire className="size-6" />
                )}
                {t(z.label)}
              </Link>
            ))}
