...
export const initialQuests: QuestItemComponentType[] = [
  ...
  //   quest_name: "UTXO Global x d.id on Galxe",
  //   quest_description: "Complete all social media tasks on Galxe to receive 300 points.",
  //   guideLink: null,
  //   is_claimed: false,
  //   quest_number: 4,
  //   reward_points: 300,
  //   duration: "Dec 3, 7:00PM UTC+8 - Dec 8, 7:00PM UTC+8",
  //   bonusReward: false,
  //   questLink: galxeLink,
  //   disabled: false,
  //   labelButton: "Go",
